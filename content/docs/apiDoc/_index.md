...
### 2.4 获取报文合格率
- **接口说明：** 报文合格率 tips:合格设备数组：所有有效报文数等于所有报文数的设备编号
...
```
{
    "results": {
        "qualifiedTotal": [
            "32059423001310002240",
            "32058200001310000401",
            "32050651001320100630"
        ],
        "checkTotal": [
            "32050651001320100630",
            "32058200001310000401",
...
### 2.5 场景图URL异常率
- **接口说明：** 场景图URL异常率 tips:接收的场景图URL访问异常：code为5011014  接收的场景图图片总数： code 为 5011014 和 2010014的图片数之和
...
```
{
    "results": {
        "abnormalTotal": [
            "32058200001310000426",
            "32059423001310002241"
        ],
        "receiveTotal": [
            "32058200001310000426",
            "32059423001310002241"
...
### 2.6 场景图不可用率
- **接口说明：** 场景图不可用率 tips:接收的场景图URL访问异常：code为5010014  接收的场景图图片总数： code 为 2010014 和 5010014的图片数之和
...
```
{
    "results": {
        ...
        "receiveTotal": [
            "32059423001310002240",
            "32059453011320022001",
            "32059453011320022001",
            "32058253001324076656",
            "32058253001324076656",
            "32058253001324076656",
            "32059423001310002240",
            "32059453011320022001",
            ...
            "32058200001310000426",
            "32058200001310000426",
            "32058263051320900031",
            "32058263051320900031",
            "32058263051320900005",
            "32058263051320900005",
            "32058254001310206429",
            "32058254001310206429",
            "32058254001310206429",
            "32058254001310206429",
            "32058368001310149987",
            "32058368001310149987",
            "32058368001310149987",
            "32058368001310149987",
            "32059423001310002240",
...
- **接口地址：** /external/face_disqualification?device_id=?
- **接口方法：** GET

#### 2.7.1 请求参数

参数名称						|类型		|出现要求	|描述  
device_id			         	|int		|R			|设备ID
